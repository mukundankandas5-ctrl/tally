...
app.get("/api/connector-download", (req, res) => {
  res.redirect(302, "https://github.com/mukundankandas5-ctrl/tally/releases/latest/download/Tally.AI.Connector.Setup.1.0.1.exe");
});
...
app.use("/api/reconcile", gstr2bRoutes);
